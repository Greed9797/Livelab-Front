      ...
      <CardBody>
        <DataTable<JsonRecord>
          ...
          columns={[
            ...
            { key: 'gmv', header: subject === 'marca' ? 'GMV hoje' : 'GMV hoje', align: 'right', render: (item) => formatMoney(item.gmv ?? item.valor, true) },
            { key: 'lives', header: 'Lives hoje', align: 'right', render: (item) => asNumber(item.lives ?? item.total_lives).toLocaleString('pt-BR') },
