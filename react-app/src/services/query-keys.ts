...
export const QK = {
  ...
  knowledgeGlobalCategories: (tenantId?: string) => ['knowledge-global', tenantId ?? '', 'categories'] as const,
  knowledgeGlobalArticles: (tenantId?: string, filters?: Record<string, unknown>) => ['knowledge-global', tenantId ?? '', 'articles', filters ?? {}] as const,
  knowledgeGlobalArticle: (tenantId: string | undefined, idOrSlug: string) => ['knowledge-global', tenantId ?? '', 'article', idOrSlug] as const,
  ...
  trainingHome: (tenantId?: string, role?: string) => ['training', tenantId ?? '', 'home', role ?? ''] as const,
  ...
  trainingLesson: (tenantId: string | undefined, id: string) => ['training', tenantId ?? '', 'lesson', id, 'start-false'] as const,
