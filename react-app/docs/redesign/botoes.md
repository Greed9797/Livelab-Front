...
Para ações somente com ícone, use `Button size="icon"` (36px, sem padding horizontal) e um nome acessível. Não combine largura estreita com classes de padding do botão textual: o padding pode comprimir o SVG até largura zero.
