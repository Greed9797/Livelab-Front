...
export const menuItems: MenuItem[] = [
  ...
  // "Minha conta" (trocar senha) fica só para papéis SEM tela de Configurações.
  // Cliente troca a senha dentro de /cliente/configuracoes (aba Segurança).
  { label: 'Minha conta', path: '/conta', icon: KeyRound, roles: allRoles.filter((role) => role !== 'cliente_parceiro') },
